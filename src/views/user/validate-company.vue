      ...
      <el-table v-loading="listLoading" :data="list" border fit highlight-current-row size="mini" style="font-size: 14px;">
        ...
        <el-table-column label="认证状态状态" width="120">
          <template slot-scope="{row}">
            ...
            <el-tag v-if="row.status === 2" type="success" size="small"><span>认证通过</span></el-tag>
            <el-popover
              placement="bottom"
              title="审核未通过原因："
              width="200"
              ...
              :content="row.msg"
              >
              <el-tag v-if="row.status === 3" slot="reference" type="danger" class="cursor-type" size="small"><span>认证被驳回</span></el-tag>
            </el-popover>
          </template>
        </el-table-column>
