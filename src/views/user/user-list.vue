<template>
  <div class="app-container">
    <el-row class="filter-container" :gutter="10">
      ...
      <el-col :sm="3">
        <el-select v-model="listQuery.vip_level" placeholder="会员等级" size="medium" clearable>
      ...
      <el-col :sm="5">
        ...
        <el-button v-waves v-permission="['role/edit-role']" type="success" size="medium" icon="el-icon-edit"
                   @click="handleCreate">
          创建用户
        </el-button>
      </el-col>
